#生成广州的MCAR缺失文件 (Generate MCAR missing position file for Guangzhou)
import torch
import numpy as np
import random
...
for missing_p in missing_ps:
    for seed in seeds:
        ...
        np.savetxt("/mnt/4T/IJCAI/FGTI/Data/data/guangzhou_" + str(missing_p) + "_" + str(seed) + ".csv", mask_target, fmt="%d", delimiter=",")
