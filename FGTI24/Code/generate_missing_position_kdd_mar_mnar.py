...
for seed in seeds:
    ...
    np.savetxt("/mnt/4T/IJCAI/FGTI/Data/data/kddmar_" + str(missing_p) + "_" + str(seed) + ".csv", mar_mask, fmt="%d", delimiter=",")
    np.savetxt("/mnt/4T/IJCAI/FGTI/Data/data/kddmnar_" + str(missing_p) + "_" + str(seed) + ".csv", mnar_mask, fmt="%d", delimiter=",")
